 ...
 *        This file is part of the FSMProject distribution (.
...
/*Demonstration of SubString Counter*/
  ...
  fsm_t *fsm_substr_counter = fsm_substring_counter("Purbayan\0", strlen("Purbayan\0"));
  //fsm_register_input_matching_fn_cb(fsm_substr_counter, match_any_character_match_fn);
  char *input_string = 
    "Hello, My name is Purbayan. "
    "Visit my website : Coming soon"
    "which was created by Purbayan Majumder\0";
